table 50066 "Specification Details"
{
        ...
        field(4; "Qlty Measure Code"; Code[10])
        {
            ...
            begin
                ...
                IF "Account Type" = "Account Type"::Posting THEN BEGIN
                    ...
                    // "Unit of Measure" := QltyMeasure."Unit of Measure"; //PCPL-0070
                END;
            end;
        }
        ...
        */
        ...
        ELSE
            IF "Account Type" = "Account Type"::"End" THEN BEGIN
                ...
                // Description := recGroup.Description + ' END'; //PCPL-0070
            END;
        //PCPL
    ...
    begin
        ...
        */
        ...
        IF "Account Type" = "Account Type"::"Begin" THEN BEGIN
            // recGroup.GET("Group Code");
            // Description := recGroup.Description; //PCPL-0070
            "Parent Group Code" := "Group Code";
        END
        ELSE
            IF "Account Type" = "Account Type"::"End" THEN BEGIN
    ...
    var
        ...
        //recGroup: Record "Specification Group";
        recSpecification: Record "Specification Details";
