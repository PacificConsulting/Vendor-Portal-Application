            ...
            action(CreatePO)
            {
                ...
                begin
                    ...
                    IF recpurcha.FINDFIRST THEN BEGIN
                        ...
                        fpay := recpurcha."Payment Terms Portal Use";
                    END;
                    ...
                    IF recpurchb.FINDSET THEN BEGIN
                        REPEAT
                            IF (recpurchb."Vendor No." <> fvend) OR (recpurchb."Location Code" <> floca) OR (recpurchb."Payment Terms Portal Use" <> fpay) THEN BEGIN
